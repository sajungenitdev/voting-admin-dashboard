    ...
    <div className="text-center py-12 bg-black rounded-2xl border border-red-500/20">
      ...
      {action && action.onClick && (
        <button
          ...
          className="mt-4 px-4 py-2 bg-linear-to-r from-red-500 to-red-700 rounded-xl text-white text-sm font-medium hover:shadow-lg hover:shadow-red-500/25 transition-all duration-300"
        >
          {action.label}
        </button>
      )}
